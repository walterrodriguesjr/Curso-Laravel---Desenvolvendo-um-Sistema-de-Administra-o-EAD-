...
<div class="">
    ...
    <input class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="name" name="name" type="text" placeholder="Nome" aria-label="Name" name="name" value="{{ $lesson->video ?? old('video') }}">
</div>
<div class="mt-2">
